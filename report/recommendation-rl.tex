...
The comparison of the different viable algorithms have show the following : 
\begin{itemize}
...
We ask the following question : does collaborative filtering models work better than content based models because we recommend movies or are the results generalizable to any kind of recommendation ?
