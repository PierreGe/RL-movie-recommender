...
We ran each algorithm for several hundred epochs and averaged the results over more than 100 users. Results can be found in section \ref{results} \todo{explain the simulation better}
