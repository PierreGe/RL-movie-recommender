...
The content based heuristic try to find a movie that is close to the learned user preferences.



\todo{expliquer comme dans le paier}

\subsubsection{Collaborative filtering}

\todo{expliquer l'adptattion pour faire du collaborative}


\subsection{Bandit strategies}

\todo{faire une subsubsection avec chaque dapproches utilisés, greedy, linucb, greedyucb, bayes}
