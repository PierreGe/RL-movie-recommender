...
The problem of movie recommandation is modeled as a contextual multi-armed bandit [\cite{sutton1998reinforcement}] [\cite{lu2010contextual}] which has the following advantages.
...
\subsubsection{GreedyUCB}

\todo{GreedyUCB}

\subsubsection{BayesUCB}
...
\todo{explain how simulation is done}
